...
int WINAPI wWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPWSTR lpCmdLine, int nCmdShow)
{
    ...
    std::unique_ptr<ModelFile> modelfile;
    modelfile = std::make_unique<ModelFile>();
    modelfile->Load("./Assets/Model/YBot.fbx");
    ...
    while (system->DispatchWindowMessage())
    {
        ...
        ImGui::DragFloat3("light direction", (float*)&light.directionLight.direction);
        ImGui::ColorEdit3("light color", (float*)&light.directionLight.color);
        ImGui::DragFloat3("light eyePos", (float*)&light.eyePos);
